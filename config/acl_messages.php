...
return [
    'title' => [
        'app-name' => 'Hệ thống quản lý thực tập'
    ],
    ...
    "email" => [
        ...
        */
         ...
         */
        "user_password_recovery_subject" => "[Hệ thống quản lý thực tập] Gửi yêu cầu khôi phục mật khẩu",
    ],
